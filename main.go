...
func init() {
	os.Setenv("APP_ID", "4e044b4b31a64d048bb721ca803a0faa")
	os.Setenv("APP_CERTIFICATE", "ef9b88aa5a654e4caa1cbb66f4b514e7")
...
func getRtmToken(c *gin.Context) {
	...
	rtmToken, tokenErr := rtmtokenbuilder.BuildToken(appID, appCertificate, uidStr, uint32(expireTimestamp), "")
...
func getBothTokens(c *gin.Context) {
	...
	// generate rtmToken
	rtmToken, rtmTokenErr := rtmtokenbuilder.BuildToken(appID, appCertificate, uidStr, uint32(expireTimestamp), "")
